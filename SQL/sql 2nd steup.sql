...
select concat(emp_name, "working in",emp_city,"city") from emp;

select upper(concat(emp_name, "working in",emp_city,"city")) from emp;

select concat(upper(emp_name), "working in",emp_city,"city") from emp;

select substring("welcome student",-3,4);

select substring("welcome student",-5,4);
...
select last_day("2024-07-16");

select adddate(sysdate(),12);
...
select emp_city,sum(emp_salary) as "total salary",count(empid) as "total employe"  from emp group by emp_city;

select * from emp;

select emp_city,sum(emp_salary) as "total salary",count(empid)from emp group by emp_city having count(*)>1;

select emp_city,sum(emp_salary) as "total salary",
count(empid) as "total employe"  from emp 
where emp_city="kalyan"
 group by emp_city;
